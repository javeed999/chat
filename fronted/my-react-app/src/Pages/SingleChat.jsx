...
//                                 {
//                                     setNotifications([newMessageReceived,...messages])
...
const SingleChat = ({ fetchAgain, setFetchAgain }) => {
  ...
  useEffect(() => {
    const handleMessage = (newMessageReceived) => {
      if (!selectedChatCompare || selectedChatCompare._id !== newMessageReceived.chat._id) {
        const alreadyExists = notifications.some(msg => msg._id === newMessageReceived._id);
        if (!alreadyExists) {
  ...
  }, [notifications, selectedChatCompare]);
